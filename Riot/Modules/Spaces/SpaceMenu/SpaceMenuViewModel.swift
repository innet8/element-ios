...
class SpaceMenuViewModel: SpaceMenuViewModelType {
    ...
    private let spaceMenuItems: [SpaceMenuListItemViewData] = [
        SpaceMenuListItemViewData(action: .invite, style: .normal, title: VectorL10n.spacesInvitePeople, icon: Asset.Images.mySpaceInviteUser.image, value: nil),
        SpaceMenuListItemViewData(action: .exploreSpaceRooms, style: .normal, title: VectorL10n.spacesExploreRooms, icon: Asset.Images.mySpaceMenuRooms.image, value: nil),
        SpaceMenuListItemViewData(action: .exploreSpaceMembers, style: .normal, title: VectorL10n.roomDetailsPeople, icon: Asset.Images.mySpaceMenuMembers.image, value: nil),
        SpaceMenuListItemViewData(action: .settings, style: .normal, title: VectorL10n.sideMenuActionSettings, icon: Asset.Images.someMenuActionIconSettings.image, value: nil),
        SpaceMenuListItemViewData(action: .addRoom, style: .normal, title: VectorL10n.spacesAddRoom, icon: Asset.Images.mySpaceMenuPlusIcon.image, value: nil),
        SpaceMenuListItemViewData(action: .addSpace, style: .normal, title: VectorL10n.spacesAddSpace, icon: Asset.Images.mySpaceMenuPlusIcon.image, value: nil, isBeta: true),
        SpaceMenuListItemViewData(action: .leaveSpace, style: .destructive, title: VectorL10n.leave, icon: Asset.Images.mySpaceMenuLeave.image, value: nil)
    ]
