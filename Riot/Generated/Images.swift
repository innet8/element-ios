...
internal class Asset: NSObject {
  ...
  @objc(AssetImages) internal class Images: NSObject {
    ...
    internal static let mobileAudioMuteOffIcon = ImageAsset(name: "mobile_audio_mute_off_icon")
    internal static let mobileAudioMuteOnIcon = ImageAsset(name: "mobile_audio_mute_on_icon")
    internal static let mobileAudioRouteBuiltin = ImageAsset(name: "mobile_audio_route_builtin")
    internal static let mobileAudioRouteHeadphones = ImageAsset(name: "mobile_audio_route_headphones")
    internal static let mobileAudioRouteSpeakers = ImageAsset(name: "mobile_audio_route_speakers")
    internal static let mobileChatIcon = ImageAsset(name: "mobile_chat_icon")
    internal static let mobileDialpadBackspaceIcon = ImageAsset(name: "mobile_dialpad_backspace_icon")
    internal static let mobileDialpadCallIcon = ImageAsset(name: "mobile_dialpad_call_icon")
    internal static let mobileGoToChatIcon = ImageAsset(name: "mobile_go_to_chat_icon")
    internal static let mobileHangupLarge = ImageAsset(name: "mobile_hangup_large")
    internal static let mobileMissedVideo = ImageAsset(name: "mobile_missed_video")
    internal static let mobileMissedVoice = ImageAsset(name: "mobile_missed_voice")
    internal static let mobileMoreIcon = ImageAsset(name: "mobile_more_icon")
    internal static let mobilePausedIcon = ImageAsset(name: "mobile_paused_icon")
    internal static let mobilePausedWhiteIcon = ImageAsset(name: "mobile_paused_white_icon")
    internal static let mobilePipIcon = ImageAsset(name: "mobile_pip_icon")
    internal static let mobileSpeakerExternalIcon = ImageAsset(name: "mobile_speaker_external_icon")
    internal static let mobileSpeakerOffIcon = ImageAsset(name: "mobile_speaker_off_icon")
    internal static let mobileSpeakerOnIcon = ImageAsset(name: "mobile_speaker_on_icon")
    internal static let mobileVideoIcon = ImageAsset(name: "mobile_video_icon")
    internal static let mobileVideoMuteOffIcon = ImageAsset(name: "mobile_video_mute_off_icon")
    internal static let mobileVideoMuteOnIcon = ImageAsset(name: "mobile_video_mute_on_icon")
    internal static let commonAppSymbol = ImageAsset(name: "common_app_symbol")
    internal static let commonBackIcon = ImageAsset(name: "common_back_icon")
    internal static let commonCamera = ImageAsset(name: "common_camera")
    internal static let commonCheckmark = ImageAsset(name: "common_checkmark")
    internal static let commonChevron = ImageAsset(name: "common_chevron")
    internal static let commonCloseButton = ImageAsset(name: "common_close_button")
    internal static let commonCoachMark = ImageAsset(name: "common_coach_mark")
    internal static let commonDisclosureIcon = ImageAsset(name: "common_disclosure_icon")
    internal static let commonErrorIcon = ImageAsset(name: "common_error_icon")
    internal static let commonExclamationCircle = ImageAsset(name: "common_exclamation_circle")
    internal static let commonFaceidIcon = ImageAsset(name: "common_faceid_icon")
    internal static let commonFilterOff = ImageAsset(name: "common_filter_off")
    internal static let commonFilterOn = ImageAsset(name: "common_filter_on")
    internal static let commonGroup = ImageAsset(name: "common_group")
    internal static let commonInformationButton = ImageAsset(name: "common_information_button")
    internal static let commonMonitor = ImageAsset(name: "common_monitor")
    internal static let commonPlaceholder = ImageAsset(name: "common_placeholder")
    internal static let commonPlusIcon = ImageAsset(name: "common_plus_icon")
    internal static let commonRemoveIcon = ImageAsset(name: "common_remove_icon")
    internal static let commonRevealPasswordButton = ImageAsset(name: "common_reveal_password_button")
    internal static let commonSelectionTick = ImageAsset(name: "common_selection_tick")
    internal static let commonSelectionUntick = ImageAsset(name: "common_selection_untick")
    internal static let commonShareActionButton = ImageAsset(name: "common_share_action_button")
    internal static let commonShrinkIcon = ImageAsset(name: "common_shrink_icon")
    internal static let commonSmartphone = ImageAsset(name: "common_smartphone")
    internal static let commonStartChat = ImageAsset(name: "common_start_chat")
    internal static let commonTouchidIcon = ImageAsset(name: "common_touchid_icon")
    internal static let addGroupParticipantIcon = ImageAsset(name: "add_group_participant_icon")
    internal static let removeIconBlueCommon = ImageAsset(name: "remove_icon_blue_common")
    ...
    internal static let findYourContactsFacepileIcon = ImageAsset(name: "find_your_contacts_facepile_icon")
    ...
    internal static let deviceTypeDesktopIcon = ImageAsset(name: "device_type_desktop_icon")
    internal static let deviceTypeMobileIcon = ImageAsset(name: "device_type_mobile_icon")
    internal static let deviceTypeUnknownIcon = ImageAsset(name: "device_type_unknown_icon")
    internal static let deviceTypeWebIcon = ImageAsset(name: "device_type_web_icon")
    internal static let userOtherSessionsFilterIcon = ImageAsset(name: "user_other_sessions_filter_icon")
    internal static let userOtherSessionsFilterSelectedIcon = ImageAsset(name: "user_other_sessions_filter_selected_icon")
    internal static let userOtherSessionsInactiveIcon = ImageAsset(name: "user_other_sessions_inactive_icon")
    internal static let userOtherSessionsUnverifiedIcon = ImageAsset(name: "user_other_sessions_unverified_icon")
    internal static let userOtherSessionsVerifiedIcon = ImageAsset(name: "user_other_sessions_verified_icon")
    internal static let userSessionListItemInactiveSessionIcon = ImageAsset(name: "user_session_list_item_inactive_session_icon")
    internal static let userSessionListItemNotSelectedIcon = ImageAsset(name: "user_session_list_item_not_selected_icon")
    internal static let userSessionListItemSelectedIcon = ImageAsset(name: "user_session_list_item_selected_icon")
    internal static let userSessionUnverifiedIcon = ImageAsset(name: "user_session_unverified_icon")
    internal static let userSessionVerificationUnknownIcon = ImageAsset(name: "user_session_verification_unknown_icon")
    internal static let userSessionVerifiedIcon = ImageAsset(name: "user_session_verified_icon")
    internal static let userSessionsInactiveIcon = ImageAsset(name: "user_sessions_inactive_icon")
    internal static let userSessionsUnverifiedIcon = ImageAsset(name: "user_sessions_unverified_icon")
    ...
    internal static let encryptionNormalIcon = ImageAsset(name: "encryption_normal_icon")
    internal static let encryptionTrustedIcon = ImageAsset(name: "encryption_trusted_icon")
    internal static let encryptionUntrustedIcon = ImageAsset(name: "encryption_untrusted_icon")
    internal static let encryptionWarningIcon = ImageAsset(name: "encryption_warning_icon")
    ...
    internal static let loginEmailIcon = ImageAsset(name: "login_email_icon")
    internal static let loginMsisdnIcon = ImageAsset(name: "login_msisdn_icon")
    internal static let loginPasswordIcon = ImageAsset(name: "login_password_icon")
    internal static let loginQrloginConfirmIcon = ImageAsset(name: "login_qrlogin_confirm_icon")
    internal static let loginRecaptchaIcon = ImageAsset(name: "login_recaptcha_icon")
    internal static let loginRevealPassword = ImageAsset(name: "login_reveal_password")
    internal static let loginServerSelectionIcon = ImageAsset(name: "login_server_selection_icon")
    internal static let loginSsoIconApple = ImageAsset(name: "login_sso_icon_apple")
    internal static let loginSsoIconFacebook = ImageAsset(name: "login_sso_icon_facebook")
    internal static let loginSsoIconGithub = ImageAsset(name: "login_sso_icon_github")
    internal static let loginSsoIconGitlab = ImageAsset(name: "login_sso_icon_gitlab")
    internal static let loginSsoIconGoogle = ImageAsset(name: "login_sso_icon_google")
    internal static let loginSsoIconTwitter = ImageAsset(name: "login_sso_icon_twitter")
    internal static let loginTermsIcon = ImageAsset(name: "login_terms_icon")
    ...
    internal static let screenAvatarCamera = ImageAsset(name: "screen_avatar_camera")
    internal static let screenAvatarEdit = ImageAsset(name: "screen_avatar_edit")
    internal static let screenCelebrationIcon = ImageAsset(name: "screen_celebration_icon")
    internal static let screenCongratulationsIcon = ImageAsset(name: "screen_congratulations_icon")
    internal static let screenSplashScreenPage1 = ImageAsset(name: "screen_splash_screen_page_1")
    internal static let screenSplashScreenPage1Dark = ImageAsset(name: "screen_splash_screen_page_1_dark")
    internal static let screenSplashScreenPage2 = ImageAsset(name: "screen_splash_screen_page_2")
    internal static let screenSplashScreenPage2Dark = ImageAsset(name: "screen_splash_screen_page_2_dark")
    internal static let screenSplashScreenPage3 = ImageAsset(name: "screen_splash_screen_page_3")
    internal static let screenSplashScreenPage3Dark = ImageAsset(name: "screen_splash_screen_page_3_dark")
    internal static let screenSplashScreenPage4 = ImageAsset(name: "screen_splash_screen_page_4")
    internal static let screenSplashScreenPage4Dark = ImageAsset(name: "screen_splash_screen_page_4_dark")
    internal static let screenUseCaseCommunity = ImageAsset(name: "screen_use_case_community")
    internal static let screenUseCaseCommunityDark = ImageAsset(name: "screen_use_case_community_dark")
    internal static let screenUseCaseIcon = ImageAsset(name: "screen_use_case_icon")
    internal static let screenUseCasePersonal = ImageAsset(name: "screen_use_case_personal")
    internal static let screenUseCasePersonalDark = ImageAsset(name: "screen_use_case_personal_dark")
    internal static let screenUseCaseWork = ImageAsset(name: "screen_use_case_work")
    internal static let screenUseCaseWorkDark = ImageAsset(name: "screen_use_case_work_dark")
    ...
    internal static let someMenuActionIconFeedback = ImageAsset(name: "some_menu_action_icon_feedback")
    internal static let someMenuActionIconHelp = ImageAsset(name: "some_menu_action_icon_help")
    internal static let someMenuActionIconSettings = ImageAsset(name: "some_menu_action_icon_settings")
    internal static let someMenuActionIconShare = ImageAsset(name: "some_menu_action_icon_share")
    internal static let someMenuIcon = ImageAsset(name: "some_menu_icon")
    internal static let someMenuNotifIcon = ImageAsset(name: "some_menu_notif_icon")
    internal static let featureSpacesUnavaibleArtwork = ImageAsset(name: "feature_spaces_unavaible_artwork")
    internal static let featureSpacesUnavaibleArtworkDark = ImageAsset(name: "feature_spaces_unavaible_artwork_dark")
    internal static let mySpaceAddRoom = ImageAsset(name: "my_space_add_room")
    internal static let mySpaceCreationCamera = ImageAsset(name: "my_space_creation_camera")
    internal static let mySpaceCreationPrivate = ImageAsset(name: "my_space_creation_private")
    internal static let mySpaceCreationPublic = ImageAsset(name: "my_space_creation_public")
    internal static let mySpaceHomeIconDark = ImageAsset(name: "my_space_home_icon_dark")
    internal static let mySpaceHomeIconLight = ImageAsset(name: "my_space_home_icon_light")
    internal static let mySpaceInviteUser = ImageAsset(name: "my_space_invite_user")
    internal static let mySpaceMenuClose = ImageAsset(name: "my_space_menu_close")
    internal static let mySpaceMenuLeave = ImageAsset(name: "my_space_menu_leave")
    internal static let mySpaceMenuMembers = ImageAsset(name: "my_space_menu_members")
    internal static let mySpaceMenuPlusIcon = ImageAsset(name: "my_space_menu_plus_icon")
    internal static let mySpaceMenuRooms = ImageAsset(name: "my_space_menu_rooms")
    internal static let mySpacePrivateIcon = ImageAsset(name: "my_space_private_icon")
    internal static let mySpaceRoomIcon = ImageAsset(name: "my_space_room_icon")
    internal static let mySpaceUserIcon = ImageAsset(name: "my_space_user_icon")
    internal static let mySpacesAddSpaceDark = ImageAsset(name: "my_spaces_add_space_dark")
    internal static let mySpacesAddSpaceLight = ImageAsset(name: "my_spaces_add_space_light")
    internal static let mySpacesInviteUsers = ImageAsset(name: "my_spaces_invite_users")
    internal static let mySpacesModalBack = ImageAsset(name: "my_spaces_modal_back")
    internal static let mySpacesModalClose = ImageAsset(name: "my_spaces_modal_close")
    internal static let mySpacesMore = ImageAsset(name: "my_spaces_more")
    internal static let spaceTypeIcon = ImageAsset(name: "space_type_icon")
    internal static let tabbarFavouritesIcon = ImageAsset(name: "tabbar_favourites_icon")
    internal static let tabbarGroupsIcon = ImageAsset(name: "tabbar_groups_icon")
    internal static let tabbarHomeIcon = ImageAsset(name: "tabbar_home_icon")
    internal static let tabbarPeopleIcon = ImageAsset(name: "tabbar_people_icon")
    internal static let tabbarRoomsIcon = ImageAsset(name: "tabbar_rooms_icon")
    internal static let voicePlayBackward30s = ImageAsset(name: "voice_play_backward_30s")
    internal static let voicePlayForward30s = ImageAsset(name: "voice_play_forward_30s")
    internal static let voicePlayLive = ImageAsset(name: "voice_play_live")
    internal static let voicePlayPause = ImageAsset(name: "voice_play_pause")
    internal static let voicePlayRecord = ImageAsset(name: "voice_play_record")
    internal static let voicePlayRecordPause = ImageAsset(name: "voice_play_record_pause")
    internal static let voicePlaySliderMaxTrack = ImageAsset(name: "voice_play_slider_max_track")
    internal static let voicePlaySliderMinTrack = ImageAsset(name: "voice_play_slider_min_track")
    internal static let voicePlaySliderThumb = ImageAsset(name: "voice_play_slider_thumb")
    internal static let voicePlaySpinner = ImageAsset(name: "voice_play_spinner")
    internal static let voicePlayStop = ImageAsset(name: "voice_play_stop")
    internal static let voicePlayTileLive = ImageAsset(name: "voice_play_tile_live")
    internal static let voicePlayTileMic = ImageAsset(name: "voice_play_tile_mic")
    internal static let voicePlayTimeLeft = ImageAsset(name: "voice_play_time_left")
    internal static let voicePlayVideo = ImageAsset(name: "voice_play_video")
